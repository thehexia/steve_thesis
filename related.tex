...
%
% NOTE: You only really need one citation per section -- or whenever the
% context becomes unclear.
Much of the work on the development of technologies and programming languages for SDN is targeted at OpenFlow: a specification describing the general architecture of SDN switches and the protocol that allows them to be remotely observed and controlled.
...
% FIXME: It might be worthwhile to talk about tcpdump... It's called BPF:
% Berkely Packet Filter.


\section{Open VSwtitch}
\label{rel:vswitch}

% FIXME: You want something brief here.

\section{Open Data Plane}
\label{rel:freeflow}

% FIXME: Maybe this too.

% FIXME: I moved this down so that the related work would focus on language
% related featuers.
\section{Freeflow}
\label{rel:freeflow}
