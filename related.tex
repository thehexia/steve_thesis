...
Steve is middle ground between P4 and POF, but also attempts to
...
Also unlike P4, Steve allows the user to specify the complete pipeline logic, including pipeline composition, flow entry definitions, and flow entry insertion/removal. Because of this, the Steve compiler is able to reason about the safety of all flow entries which could ever exist and all potential paths that may exist at runtime.
