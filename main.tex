...
\lstset{basicstyle=\ttfamily\singlespacing,
	    emph={layout, int, uint, decoder, extract, var, else, if, requires, exact_table, output, decode, goto, advance, drop, flood, set, write, insert, into, remove, from, match, case, while, miss, break, continue},
