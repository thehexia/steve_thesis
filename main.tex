...
\lstset{
	    ...
	    emph={
	    	layout, int, uint, decoder, extract, var, else, if, exact_table, event, match, case, while, miss, break, continue, Port, return, def, in\_port, in\_phys\_port, egress, reflow, controller, all, timeout
	    },
	    emph=[2]{ start, as, requires, advance },
	    emph=[3]
	    { 
	    	output, decode, goto, drop, flood, set, write, clear, raise, insert, into, remove, from, 
	    },
