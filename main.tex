...
\lstset{basicstyle=\ttfamily\singlespacing\small,
	    emph={layout, int, uint, decoder, extract, var, else, if, requires, exact_table, event, output, decode, goto, advance, drop, flood, set, write, clear, raise, insert, into, remove, from, match, case, while, miss, break, continue, Port},
