...
Unfortunately, modern switches suffer from a number of issues which make them difficult to use with evolving technologies.

Switches are rigid both in firmware and in hardware.
They cannot be easily, if ever, reconfigured to meet new needs.
A device that was built to be a router will likely always be a router. If it did not support load or content balancing to start with, it likely never will due to hardware limitations.
There is a strong desire in the industry to have switching hardware which can be easily reconfigured or reprogrammed to meet new, arbitrary needs.

This inflexibility prevents network applications . 
