...
for programmable SDN switches. Steve ensures a network application is safe, while still being as efficient as possible.
Additionally, Steve is more expressive for this domain; the programmer is only concerned with expressing the high-level logic of the network application rather than low-level implementation details.
...
Chapter \ref{ch:tutorial} describes the Steve programming language semantics in greater detail and provides additional use cases.
