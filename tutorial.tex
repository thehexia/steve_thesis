...
\cite{vlan_std} inserted before the \texttt{type} field of an Ethernet
header.
...
In this example, two layouts are declared: \texttt{ethernet} and \texttt{vlan}. 
To express a VLAN structure within the Ethernet header, a field named \texttt{vtag} is added to
