...
It is possible to define this kind of transport layer firewall in Steve. This firewall will be an extension to the learning router from Section \ref{tut:learning_router}.

The \texttt{ethernet} and \texttt{ipv4} layouts from the learning router will remain the same. In addition to these, two transport layer layouts must also be defined: the UDP and the TCP layouts.
