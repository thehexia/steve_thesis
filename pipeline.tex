...
plane capable of registering events and executing event handlers. Additionally, it must support function calls, variable allocation, and arithmetic.
...
\textbf{Remove flow entry \texttt{<mf> <t>}}. This removes a flow entry with the given match fields from $t$.
