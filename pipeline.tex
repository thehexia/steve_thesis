...
\item \textbf{Controller}. This port acts as a logical communication channel between data plane and control plane. When raising an event, the packet is dispatched to this port, which then dispatches the packet to the appropriate event handler.
