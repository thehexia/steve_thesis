...
\begin{algorithm}[ht]
 ...
 \Function{DFS}{$G, v, p$}
 	...
 	\If{v.requirements $\subseteq$ p} \Comment{Check for requirement satisfaction.}
	...
	\Else
 	...
 	\State p = p $\setminus$ difference \Comment{Remove the productions of this vertex from the set of productions when backtracking.}
 \EndFunction
 \end{algorithmic}
