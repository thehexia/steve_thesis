...
By extension, because layouts must contain fields of DST, Steve cannot allow layouts to function like user-defined type. Therefore, objects of layout type can never be created.
